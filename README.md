# token_balance
🧮 Cek saldo token ERC20 di wallet tertentu

Script untuk mengecek saldo token ERC20 pada alamat wallet tertentu.
...
2. Edit `RPC_URL` dan `TOKEN_ADDRESS` di `main.py`
